...
public class CommandHelp {
	...
	private static String generalHelp = 
					...
					+ EnumChatFormatting.GOLD + "/pokedex help top" + EnumChatFormatting.AQUA + " Display a list of categories for the top command\n"
					...
					+ EnumChatFormatting.GOLD + "/pokedex top <category>" + EnumChatFormatting.AQUA + " Display a list of top players in a category\n"
	...
	private static String topHelp =
					...
					+ EnumChatFormatting.GOLD + "Legendary" + EnumChatFormatting.AQUA + " Lists players who have captured the most Legendary Pixelmon\n"
